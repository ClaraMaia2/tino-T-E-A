                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                CategoryHomeCard(
                                  ...
                                  speak: () async {
                                    ...
                                    safeSetState(() {});
                                    await actions
                                        .speakText('posso ir ao banheiro?');
                                  },
                                ),
                                CategoryHomeCard(
                                  title: 'Posso beber água?',
                                  imagePath: 'assets/images/beber.png',
                                  speak: () async {
                                    FFAppState().frase =
                                        '${FFAppState().frase} Posso beber água?';
                                    safeSetState(() {});
                                    await actions
                                        .speakText('posso beber água?');
                                  },
                                ),
                              ],
                            ),
                            Wrap(
                              ...
                              children: [
                                CategoryHomeCard(
                                  title: 'Terminei meu trabalho',
                                  imagePath: 'assets/images/terminar.png',
                                  speak: () async {
                                    FFAppState().frase =
                                        '${FFAppState().frase} Terminei meu trabalho';
                                    safeSetState(() {});
                                    await actions
                                        .speakText('terminei meu trabalho');
                                  },
                                ),
                                CategoryHomeCard(
                                  title: 'Quero responder',
                                  imagePath: 'assets/images/responder.png',
                                  speak: () async {
                                    FFAppState().frase =
                                        '${FFAppState().frase} Quero responder';
                                    safeSetState(() {});
                                    await actions.speakText('quero responder');
                                  },
                                ),
                              ],
                            ),
                            Wrap(
                              ...
                              children: [
                                CategoryHomeCard(
                                  title: 'Posso usar o lápis?',
                                  imagePath: 'assets/images/lpis.png',
                                  speak: () async {
                                    FFAppState().frase =
                                        '${FFAppState().frase} Posso usar o lápis?';
                                    safeSetState(() {});
                                    await actions
                                        .speakText('posso usar o lápis?');
                                  },
                                ),
                                CategoryHomeCard(
                                  title: 'Estou cansado(a)',
                                  imagePath: 'assets/images/cansado.png',
                                  speak: () async {
                                    FFAppState().frase =
                                        '${FFAppState().frase} Estou cansado(a)';
                                    safeSetState(() {});
                                    await actions.speakText('Estou cansado(a)');
                                  },
                                ),
                              ],
                            ),
                            Wrap(
                              ...
                              children: [
                                CategoryHomeCard(
                                  title: 'Mostrar desenho',
                                  imagePath: 'assets/images/desenho.png',
                                  speak: () async {
                                    FFAppState().frase =
                                        '${FFAppState().frase} Mostrar desenho';
                                    safeSetState(() {});
                                    await actions.speakText('mostrar desenho');
                                  },
                                ),
                                CategoryHomeCard(
                                  title: 'Posso guardar meu material?',
                                  imagePath:
