                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/no_gosto_disso.png',
                                          width: 153.0,
                                          height: 153.0,
                                          fit: BoxFit.cover,
                                          alignment: Alignment(0.0, 0.0),
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.asset(
                                          'assets/images/lavar_as_mos.png',
                                          width: 153.0,
                                          height: 134.0,
                                          fit: BoxFit.contain,
                                          alignment: Alignment(0.0, 0.0),
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            FFAppState().frase =
                                                '${FFAppState().frase} Posso lavar minhas mãos?';
                                            safeSetState(() {});
                                            await actions.speakText(
                                              'posso lavar minhas mãos?',
                                            );
