...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4A90A4);
  late Color secondary = const Color(0xFFF4B183);
  ...
  late Color primaryBackground = const Color(0xFF4A90A4);
  late Color secondaryBackground = const Color(0xFFFAFAFA);
  late Color accent1 = const Color(0xFFB39DDB);
...
class ThemeTypography extends Typography {
  ...
  TextStyle get labelLarge => GoogleFonts.baloo2(
  ...
  TextStyle get labelMedium => GoogleFonts.baloo2(
        color: theme.secondaryText,
        fontWeight: FontWeight.normal,
        fontSize: 14.0,
      );
  ...
  TextStyle get labelSmall => GoogleFonts.baloo2(
        color: theme.secondaryText,
        fontWeight: FontWeight.normal,
        fontSize: 12.0,
      );
  ...
  TextStyle get bodyLarge => GoogleFonts.baloo2(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 16.0,
      );
  ...
  TextStyle get bodyMedium => GoogleFonts.baloo2(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 14.0,
      );
  ...
  TextStyle get bodySmall => GoogleFonts.baloo2(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 12.0,
      );
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1E2A2E);
  late Color secondary = const Color(0xFF7CCBA2);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF1E2A2E);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFF1E2A2E);
  late Color accent1 = const Color(0xFFB39DDB);
  late Color accent2 = const Color(0xFFFF8A65);
  late Color accent3 = const Color(0xFFE0E0E0);
  late Color accent4 = const Color(0xFFE0E0E0);
