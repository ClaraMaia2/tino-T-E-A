...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: RegisterChildInfoWidget.routeName,
          path: RegisterChildInfoWidget.routePath,
          builder: (context, params) => RegisterChildInfoWidget(),
        ),
        FFRoute(
          name: RegisterChildPhotoWidget.routeName,
          path: RegisterChildPhotoWidget.routePath,
          builder: (context, params) => RegisterChildPhotoWidget(),
        ),
        FFRoute(
          name: RegisterParentInfoWidget.routeName,
          path: RegisterParentInfoWidget.routePath,
          builder: (context, params) => RegisterParentInfoWidget(),
        ),
        FFRoute(
          name: PreferencesIconAudioWidget.routeName,
          path: PreferencesIconAudioWidget.routePath,
          builder: (context, params) => PreferencesIconAudioWidget(),
        ),
        FFRoute(
          name: PreferencesColorsWidget.routeName,
          path: PreferencesColorsWidget.routePath,
          builder: (context, params) => PreferencesColorsWidget(),
        ),
        FFRoute(
          name: PreferencesContrastWidget.routeName,
          path: PreferencesContrastWidget.routePath,
          builder: (context, params) => PreferencesContrastWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
            name: ScholarPageWidget.routeName,
            path: ScholarPageWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'ScholarPage')
                : NavBarPage(
                    initialPage: 'ScholarPage',
                    page: ScholarPageWidget(),
                  )),
        FFRoute(
          name: EmotionsPageWidget.routeName,
          path: EmotionsPageWidget.routePath,
          builder: (context, params) => EmotionsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: RelationsPageWidget.routeName,
          path: RelationsPageWidget.routePath,
          builder: (context, params) => RelationsPageWidget(),
        ),
        FFRoute(
